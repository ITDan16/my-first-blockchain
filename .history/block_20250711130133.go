...
// Сериализация блока для хеширования (должна быть стабильной!)
...
// Вычисление хеша блока (SHA256 от сериализации)
...
// Поиск nonce, при котором хеш блока начинается с N нулей (PoW)
